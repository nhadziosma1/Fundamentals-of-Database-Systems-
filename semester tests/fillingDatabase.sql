...
insert into fizicko_lice (fizicko_lice_id, ime, prezime, adresa, grad_id) values (1, 'Josephine', 'Chrisp', '12 Dennis Way', 1);
...
insert into fizicko_lice (fizicko_lice_id, ime, prezime, adresa, grad_id) values (18, 'Andréa', 'Jakes', '887 Schmedeman Way', 4);
...
insert into uposlenik (fizicko_lice_id, uposlenik_id, sef_id, plata) values (12, 2, 2, 900);
insert into uposlenik (fizicko_lice_id, uposlenik_id, sef_id, plata) values (13, 3, 3, 2500);
insert into uposlenik (fizicko_lice_id, uposlenik_id, sef_id, plata) values (14, 4, 4, 500);
insert into uposlenik (fizicko_lice_id, uposlenik_id, sef_id, plata) values (15, 5, 5, 550);
insert into uposlenik (fizicko_lice_id, uposlenik_id, sef_id, plata) values (16, 6, NULL, 5000);
insert into uposlenik (fizicko_lice_id, uposlenik_id, sef_id, plata) values (17, 7, 7, 700);
insert into uposlenik (fizicko_lice_id, uposlenik_id, sef_id, plata) values (18, 8, 8, 909);
insert into uposlenik (fizicko_lice_id, uposlenik_id, sef_id, plata) values (19, 9, NULL, 5000);
insert into uposlenik (fizicko_lice_id, uposlenik_id, sef_id, plata) values (20, 10, 10, 400);
...
insert into pravno_lice (pravno_lice_id, adresa_pravnog, broj_ugovora, grad_id, ime_pravnog) values (1, '7335 Heffernan Crossing', 1, 1, 'Lind-King');
...
insert into garancija (garancija_id, mjeseci_garancije) values (9, 6);
...
insert into proizvod  (proizvod_id, naziv_proizvoda, cijena, proizvodjac_id, garancija_id, popust_id) values (9, 'Pepper - Pablano', 26.66, 9, 9, null);
...
insert into povezna_proizvod_skladiste (proizvod_id, skladiste_id, kolicina) values (4, 4, 425);
...
insert into isporuka (isporuka_id, kurirska_sluzba_id, datum_isporuke) values (2, 2, DATE'2012-06-02');
insert into isporuka (isporuka_id, kurirska_sluzba_id, datum_isporuke) values (3, 3, DATE'2005-09-03');
insert into isporuka (isporuka_id, kurirska_sluzba_id, datum_isporuke) values (4, 4, DATE'2007-07-21');
insert into isporuka (isporuka_id, kurirska_sluzba_id, datum_isporuke) values (5, 5, DATE'2001-03-02');
insert into isporuka (isporuka_id, kurirska_sluzba_id, datum_isporuke) values (6, 6, DATE'2017-09-23');
insert into isporuka (isporuka_id, kurirska_sluzba_id, datum_isporuke) values (7, 7, DATE'2009-03-31');
...
insert into povezna_proizvod_racun (proizvod_id, racun_id, iznos_popusta, kolicina) values (1, 1, 0.7, 3086);
insert into povezna_proizvod_racun (proizvod_id, racun_id, iznos_popusta, kolicina) values (2, 2, null, 7158);
insert into povezna_proizvod_racun (proizvod_id, racun_id, iznos_popusta, kolicina) values (3, 3, null, 8259);
insert into povezna_proizvod_racun (proizvod_id, racun_id, iznos_popusta, kolicina) values (4, 4, 0.4, 3259);
insert into povezna_proizvod_racun (proizvod_id, racun_id, iznos_popusta, kolicina) values (5, 5, 0.2, 5474);
insert into povezna_proizvod_racun (proizvod_id, racun_id, iznos_popusta, kolicina) values (6, 6, 0.9, 1475);
insert into povezna_proizvod_racun (proizvod_id, racun_id, iznos_popusta, kolicina) values (7, 7, 1.0, 3155);
insert into povezna_proizvod_racun (proizvod_id, racun_id, iznos_popusta, kolicina) values (8, 8, null, 2378);
insert into povezna_proizvod_racun (proizvod_id, racun_id, iznos_popusta, kolicina) values (9, 9, 0.1, 9037);
insert into povezna_proizvod_racun (proizvod_id, racun_id, iznos_popusta, kolicina) values (10, 10, 0.5, 3626);
